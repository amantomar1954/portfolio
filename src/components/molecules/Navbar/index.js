  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-3 md:px-24 py-3">
        <div>
          <Link to="/">
            <h1 className="text-2xl text-primary font-lobster">Aman Tomar</h1>
          </Link>
        </div>
        <div>
          <ul className="lg:flex items-center hidden">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1HbZ9RcG9jWS2aPeXIS1bU6PIL84aFxxX/view?usp=sharing"
              target="blank"
            >
              <PrimaryBtn>
                <span>Resume</span>
            ...
            >
              ...
              <div className="text-center">
                <p className="text-neutral">
                  &copy; Copyright 2023, Aman Tomar. All Rights Reserved
                </p>
              </div>
            </Drawer>
          </div>
