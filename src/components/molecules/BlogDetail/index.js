  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex items-center justify-between flex-wrap mt-16 mb-4">
        <span>
          <strong className="text-primary">Aman Tomar</strong>
        </span>
        <span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-2 lg:col-span-1 px-4 py-6 rounded shadow-lg">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <EmailShareButton url={url} title="Aman Tomar ">
              <EmailIcon size={32} round={true} />
            </EmailShareButton>
            <FacebookShareButton url={url} title="Aman Tomar ">
              <FacebookIcon size={32} round={true} />
            </FacebookShareButton>
            <TwitterShareButton url={url} title="Aman Tomar ">
              <TwitterIcon size={32} round={true} />
            </TwitterShareButton>
            <LinkedinShareButton url={url} title="Aman Tomar ">
              <LinkedinIcon size={32} round={true} />
            </LinkedinShareButton>
            <WhatsappShareButton url={url} title="Aman Tomar ">
