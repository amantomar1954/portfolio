    ...
    <div className="parent pt-16 my-16">
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <h1 className="text-4xl font-semibold mb-4 text-center translate-y-[-380%] sm:translate-y-[-0%] sm:text-3xl sm:mb-2 md:text-left">Aman Tomar</h1>
            <div className="my-8">
              <TypeAnimation
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Aman Tomar
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Phone : </span>+91 9752571954
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Email : </span>
                amantomar1954@gmail.com
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>Uttam Nagar East, New Delhi, India
              </h2>
              <a
                href="https://drive.google.com/file/d/1HbZ9RcG9jWS2aPeXIS1bU6PIL84aFxxX/view"
                target="blank"
              >
